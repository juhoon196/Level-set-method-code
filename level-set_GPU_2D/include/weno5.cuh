 ...
 */
__device__ inline double weno5_dx(const double* G, int i, int j,
 ...
 */
__device__ inline double weno5_dy(const double* G, int i, int j,
 ...
 */
__device__ inline double weno5_gradient_magnitude(const double* G, int i, int j,
    ...
    double dG_dx_minus = (weno5_left(v_xm) - G[idx(i - 1, j, nx_total)]) / dx +
                         (G[idx(i, j, nx_total)] - weno5_left(v_xm)) / dx;
    dG_dx_minus = (G[idx(i, j, nx_total)] - G[idx(i - 1, j, nx_total)]) / dx;
 ...
 */
__device__ inline void weno5_gradient(const double* G, int i, int j,
